...
import { StockExchange } from "../../stockExchange/base/StockExchange";
...
export class StockResolverBase {
  ...
  async createStock(@graphql.Args() args: CreateStockArgs): Promise<Stock> {
    return await this.service.createStock({
      ...
      data: {
        ...
        stockExchange: args.data.stockExchange
          ? {
              connect: args.data.stockExchange,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => StockExchange, {
    nullable: true,
    name: "stockExchange",
  })
  @nestAccessControl.UseRoles({
  ...
  async getStockExchange(
    ...
    const result = await this.service.getStockExchange(parent.id);
